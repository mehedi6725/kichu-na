...
class TeachersPage extends StatelessWidget {
  ...
  List<Map<String,String>> students = [
    {"name" : "Al Amin" , "best_friend" : "Meghla", "Semester" : "7"},
    {"name" : "Alif Abdullah" , "best_friend" : "Arafat", "Semester" : "7"},
    {"name" : "Asraful Islam" , "best_friend" : "Bristy", "Semester" : "7"},
    {"name" : "Arafat" , "best_friend" : "Raisa", "Semester" : "7"},
    {"name" : "Mehedi" , "best_friend" : "Hasan", "Semester" : "7"},
  ];
            ...
            children: [
              ClipRRect(
                borderRadius: BorderRadius.circular(200),
                  child: Image.asset("assets/IMG_4627-02 (1).jpeg")),
              SizedBox(width: 20,),
              Text("$name"),
              SizedBox(width: 20,),
              Text("$bestFriend"),
